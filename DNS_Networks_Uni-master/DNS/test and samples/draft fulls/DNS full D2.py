        ...
        try:
            ...
            if data[0]=="AV5" :
                ...
                if data[3]=="hady-e7m" :
                    ...
                    if data[0]=="AV2" :
                        if data[5]!= "off" :
                            pausemsg="the server will be done for " +data[5] +"seconds no requests will be taken"
                            send(data[1],data[2],pausemsg,1,data[4])
                            print "the server will sleep for "+ data[5] + "seconds no requests will be taken"
                            time.sleep(int(data[5]))
